      ...
      <aside className="w-72 bg-slate-900 text-white flex-shrink-0 hidden lg:flex flex-col">
        <div className="p-8">
          <div className="flex items-center space-x-3 group cursor-pointer">
            <div className="w-10 h-10 bg-indigo-500 rounded-xl flex items-center justify-center font-black italic shadow-lg shadow-indigo-500/20 group-hover:scale-110 transition-transform duration-300">CP</div>
            <h2 className="text-2xl font-black tracking-tighter group-hover:text-indigo-400 transition-colors duration-300">CredPool</h2>
          </div>
        ...
        <div className="p-6 mt-auto border-t border-slate-800">
          ...
          <button
            onClick={onLogout}
            className="w-full text-center text-[10px] font-black text-slate-500 hover:text-rose-400 uppercase tracking-[0.2em] transition-all duration-300 hover:scale-105 active:scale-95"
          >
            LOG OUT
          </button>
        </div>
